...
export const ReputationSystem = () => {
  return (
    <div className="h-full w-full p-4 md:p-8 flex flex-col gap-8 text-gray-800 pb-24 overflow-y-auto no-scrollbar">
      ...
      <div className="flex-grow min-h-[400px] shrink-0 flex flex-col lg:flex-row gap-8 mb-8">
        ...
        <div className="w-full lg:w-2/3 bg-white/70 rounded-2xl border border-amber-200 p-8 relative overflow-hidden h-full min-h-[300px]">
