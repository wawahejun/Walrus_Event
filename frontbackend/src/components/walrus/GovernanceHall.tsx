  ...
  return (
    <div className="h-full w-full p-4 md:p-8 flex flex-col gap-8 text-gray-800 pb-24 overflow-y-auto no-scrollbar">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#F59E0B] to-white">GOVERNANCE HALL</h1>
          <p className="text-sm text-gray-600 mt-1">Private Voting & Proposal DAO</p>
        </div>
    ...
    return (
      <div className="p-6 rounded-xl bg-amber-50 border border-amber-200 flex flex-col items-center justify-center text-center min-h-[200px] relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xs text-gray-600 mt-2">Your vote has been ZK-encrypted and cast.</p>
          <div className="mt-4 text-[10px] font-mono text-gray-400">{id} • HASH: 0x9f...2a</div>
        </motion.div>
      </div>
    )
  }
